...
3. Confirm the release directory contains the installer, portable executable, and portable ZIP for the current desktop version.
...
- Create a version tag such as `v0.1.1` after the source commit.

## Release assets

Upload these files to the GitHub Release, not to the source tree:

- `release/MoeReview-<version>-x64.exe`
- `release/MoeReview-<version>-portable.exe`
- `release/MoeReview-<version>-portable.zip`
